 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint = 
		  ...
		  Person1 p1 = new Person1("Hendry Sugianto");
		  toPrint += p1.toString("902946660");
		  //Person2 replace P2 with your name
		  //and ggg000x with your gt num
		  Person2 p2 = new Person2("Omar Khan");
		  toPrint += p2.toString("902977451");
		  //Person3 replace P3 with your name
		  //and ggg000x with your gt num
		  Person3 p3 = new Person3("Jin Yong Sim");
		  toPrint += p3.toString("902889482");
          //Person4 replace P4 with your name
          //and ggg000x with your gt num
          Person4 p4 = new Person4("Parthkumar Thakkar");
          toPrint += p4.toString("902701045");
		  //Person5 replace P5 with your name
          //and ggg000x with your gt num
          Person5 p5 = new Person5("Brendan Ahn");
          toPrint += p5.toString("902949410");
